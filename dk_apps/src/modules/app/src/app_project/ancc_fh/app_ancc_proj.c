...
****************************************************************************************
*
* @file app_ancc_proj.c
*
* @brief ANCS Client project source code.
*
...
void app_send_pairing_rsp_func(struct gapc_bond_req_ind *param)
{
    ...
    cfm->data.pairing_feat.ikey_dist      = GAP_KDIST_NONE; //No key
