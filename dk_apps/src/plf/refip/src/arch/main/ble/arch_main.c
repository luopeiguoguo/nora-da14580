...
#ifdef __DA14581__
	#if (BLE_HOST_PRESENT)
    (const uint32_t *) atts_read_resp_patch,
	#endif		
#endif         
...
void patch_func (void)
{
    ...
    SetWord32(PATCH_ADDR0_REG, 0x0002a8c4);
    SetWord32(PATCH_DATA0_REG, 0xb5f8df00); //atts_read_resp svc 0 (+ enabling of interrupts)
	#endif
#endif
