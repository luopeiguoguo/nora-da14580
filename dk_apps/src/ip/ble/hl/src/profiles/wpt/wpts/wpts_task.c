 ...
 ****************************************************************************************
 */
uint8_t pru_static_data[WPTS_PRU_STATIC_CHAR_LEN] = { 0 };
uint8_t pru_dynamic_data[WPTS_PRU_DYNAMIC_CHAR_LEN] = { 0 };
                                      ...
                                      ke_task_id_t const src_id)
{
    if (KE_IDX_GET(src_id) == wpts_env.con_info.conidx)
    {
        ...
        {
            wpts_dynamic_char_read_ind_send(wpts_env.con_info.appid);
        }
    }
