...
#define WSS_MEAS_VAL_MAX_LEN               (13)

///Feature length
#define WSS_FEATURE_LEN                    (2)
 ...
 *
 * @param[in] p_meas_val Weight measurement value struct
 ****************************************************************************************
 */
uint8_t wsss_pack_meas_value(uint8_t *packed_ws, const struct wss_wt_meas* pmeas_val);
